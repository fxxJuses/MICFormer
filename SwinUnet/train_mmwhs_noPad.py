...
from SwinUnet_3DV1.SwinUnet_3D import SwinUnet3D
...
def main(args):
    ...
    model_1 = SwinUnet3D(in_channel = 2,hidden_dim=96, layers=(2, 2, 4, 2), 
                         heads=(3, 6, 9, 12), num_classes = args.num_classes,
                         window_size = 4).cuda()
